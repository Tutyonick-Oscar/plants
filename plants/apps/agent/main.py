    ...
    try:
        ...
        if isinstance(request_data, dict):
            ...
            request = ProjectRequest(
                ...
                gemini_api_key=request_data.get(
                    "gemini_api_key", DEFAULT_GEMINI_API_KEY
                ),
                weather_api_key=request_data.get(
            ...
            raise ValueError(
                "request_data doit être un dictionnaire ou une instance de ProjectRequest"
            )

        # Initialiser l'agent
        planning_agent = PlanningAgent(
            api_key=request.gemini_api_key, weather_api_key=request.weather_api_key
        )
