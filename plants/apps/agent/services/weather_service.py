...
class WeatherService:
    ...
    def analyze_growing_conditions(self, lat: float, lon: float, crop_type: str) -> Dict:
    ...
    def _analyze_corn_conditions(self, current: WeatherForecast, forecasts: List[WeatherForecast]) -> Dict:
        ...
        # Température
        if temp_avg < 10:
            analysis["risques_immediats"].append("Température trop basse pour la croissance du maïs")
    ...
    def _analyze_generic_conditions(self, current: WeatherForecast, forecasts: List[WeatherForecast]) -> Dict:
