...
class CropManagementService(BaseAgent):
    ...
    def get_crop_management_plan(
        self, crop_type: str, area: float, location: str
    ) -> Dict[str, Any]:
    ...
    def generate_irrigation_schedule(
        self, crop_data: Dict[str, Any], climate_data: Dict[str, Any]
    ) -> Dict[str, Any]:
...
"""
    ...
    def generate_fertilization_plan(
        self, soil_data: Dict[str, Any], crop_requirements: Dict[str, Any]
    ) -> Dict[str, Any]:
...
"""
    ...
    def _get_default_management_plan(
        self, crop_type: str, area: float
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "crop_type": crop_type,
            "area": area,
            "planting": {"density": "À déterminer", "spacing": "À déterminer"},
            "irrigation": {"method": "À définir", "frequency": "À définir"},
            "fertilization": {"products": "À définir", "schedule": "À définir"},
            "pest_control": {"strategy": "À développer", "products": "À définir"},
            "cultural_practices": ["Pratiques à définir selon les conditions locales"],
            "labor_equipment": {
